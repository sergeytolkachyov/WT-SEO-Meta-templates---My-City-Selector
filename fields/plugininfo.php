...
class JFormFieldPlugininfo extends JFormFieldSpacer
{
	...
	protected function getLabel()
	{
		...
		$wt_plugin_info = simplexml_load_file(JPATH_SITE."/plugins/system/wt_seo_meta_templates_mcs/wt_seo_meta_templates_mcs.xml");
		...
		<div class="media webtolk-plugin-info">
			...
			<div class="media-body">
				...
				<?php echo Text::_("PLG_WT_SEO_META_TEMPLATES_MCS_DESC"); ?>
			</div>
		</div>
<?php
